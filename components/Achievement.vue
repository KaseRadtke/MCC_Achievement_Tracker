<template>
  ...
  >
    ...
    <img
      src="..\static\gamescore_icon.png"
      alt="gamerscore_value_icon"
      class="gamerscore_icon"
    />
  </div>
</template>

<script>
import AchievementGuideModal from "./AchievementGuideModal.vue";
export default {
  components: { AchievementGuideModal },
